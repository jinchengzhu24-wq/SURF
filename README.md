...
地图相关聊天通常保持 2–4 段、约 6–10 句；话题相关时可保留 1–2 段路线推演及 1 段具体的第一人称感受。超出展示预算时仅合并重复路线链和重复感受，不因内容偏长丢弃整条正文、用户纠正、追问或方案理由。结构化响应无法可信渲染时，服务器仅依据当前快照给出中性正文；不会显示“请再发送一次”或“无法形成可验证方案”卡，也不会改动地图。
