...
public class CreativeIdeaExpansionController : MonoBehaviour
{
    ...
    private void ResolveOptionReferences()
    {
        for (int i = 0; i < 3; i++)
        {
            ...
            {
                Transform descriptionTransform = optionObject.transform.Find(
    ...
    private void ResolveOptionDescriptionScrollRects()
    {
        for (int i = 0; i < optionDescriptionTexts.Length; i++)
        {
            ...
            optionDescriptionScrollRects[i] = descriptionText != null
                ? descriptionText.GetComponentInParent<ScrollRect>()
                : null;
        }
    }
