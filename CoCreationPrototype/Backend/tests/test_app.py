...
class CoCreationPrototypeApiTests(unittest.TestCase):
    ...
    def test_frontend_and_static_assets_are_served(self):
        ...
        self.assertIn("cocreation-unified-cards-20260814-17", index_response.text)
        ...
        self.assertIn('timeoutMs: 30000', js_response.text)
        self.assertIn('elapsedSeconds < 15', js_response.text)
        ...
        self.assertIn('tradeoff: "警告"', js_response.text)
