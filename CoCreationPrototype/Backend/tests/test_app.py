...
class CoCreationPrototypeApiTests(unittest.TestCase):
    ...
    def test_frontend_and_static_assets_are_served(self):
        ...
        self.assertIn("iframe-host-v4-20260916-1", index_response.text)
        ...
        self.assertIn("DRAFT_REGENERATION_PROTOCOL_VERSION = 4", js_response.text)
        ...
        self.assertIn("draftRegenerationProtocolVersion = 4", webgl_template)
