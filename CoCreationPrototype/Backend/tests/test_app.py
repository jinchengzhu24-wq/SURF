...
class CoCreationPrototypeApiTests(unittest.TestCase):
    ...
    def test_frontend_and_static_assets_are_served(self):
        ...
        self.assertIn("cocreation-opponent-message-20260818-24", index_response.text)
        ...
        self.assertIn('elements.returnUnityButton.hidden = status !== "completed";', js_response.text)
