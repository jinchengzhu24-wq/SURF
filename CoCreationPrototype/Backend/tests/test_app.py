...
class CoCreationPrototypeApiTests(unittest.TestCase):
    ...
    def test_frontend_and_static_assets_are_served(self):
        ...
        self.assertIn("cocreation-pixel-20260812-4", index_response.text)
        self.assertIn("cocreation-guided-20260812-7", index_response.text)
        ...
        self.assertIn('tradeoff: "权衡提醒"', js_response.text)
    ...
    def test_system_prompt_is_grounded_and_neutral(self):
        ...
        self.assertIn("tradeoff uiCue", system_prompt)
