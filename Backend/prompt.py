...
DG_GUIDE_SUMMARY_SYSTEM_PROMPT = (
    ...
    "considered independently; consider_order means some pushes depend on position or order; "
    "connected_pushes means several pushes depend on one another. focused_area means important "
    "positions are concentrated within one main area; connected_areas means they are distributed "
    "across a few connected areas; wide_area means they are distributed across a wider area. "
    "short_routes means short routes connect nearby decisions; occasional_detours means mostly "
