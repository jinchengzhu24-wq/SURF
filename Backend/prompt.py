...
DG_GUIDE_SUMMARY_SYSTEM_PROMPT = (
    ...
    "Random. If both answers express the same direction, use its matching recommendation. If the "
    "two explicit answers differ, use Medium for Difficulty or Balanced for Layout. Difficulty "
    "maps low planning choices to Easy and high planning choices to Hard. Layout maps focused "
    "space with short routes to Compact, connected areas with occasional detours to Balanced, and "
    "wide space with long routes to Open. Do not let the other parameter group change this rule. "
